...
export default function Wishes() {
    ...
    // State to store the wishes list
    ...
    const handleSubmitWish = async (e) => {
        ...
        const newWishObj = {
            ...
            name: "Guest", // Replace with actual user name if needed
            message: newWish,
            attending: attendance || 'maybe',
            timestamp: new Date().toISOString()
        };

        // Add the new wish at the top of the list
        setWishes(prev => [newWishObj, ...prev]);
        setNewWish('');  // Clear input after submit
                            ...
                            <div className='backdrop-blur-sm bg-white/80 p-6 rounded-2xl border border-rose-100/50 shadow-lg'>
                                <div className='space-y-2'>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea
                                            placeholder="Send your best wishes and prayers for the couple..."
                                ...
                                <div className="flex items-center justify-between mt-4">
                                    <div className="flex items-center space-x-2 text-gray-500">
                                        ...
                                        <span className="text-sm">Give your prayer</span>
                                    </div>
                                    <motion.button
